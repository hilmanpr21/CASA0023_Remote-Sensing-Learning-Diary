...
The increasing satellite remote sensing data on earth observation in the last two decades, allows new approaches on understanding urban setting [@millerCitiesSpacePotential2003]. Satellite remote sensing data offers some advantages, such as:
